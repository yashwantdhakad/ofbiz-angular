...
const routes: Routes = [
  {
    path: '',
    children: [
      { path: '', component: FeaturegroupsComponent, data: { title: 'FEATUREGROUP.TITLE' } },
      { path: 'create', component: CreateFeaturegroupComponent, data: { title: 'FEATUREGROUP.CREATE_TITLE' } },
      { path: ':productFeatureGroupId', component: FeaturegroupDetailComponent, data: { title: 'FEATUREGROUP.DETAIL_TITLE' } },
    ],
  },
];
