...
const routes: Routes = [
  { path: 'create', component: BomCreateComponent, data: { title: 'MENU.CREATE_BOM' } },
  { path: ':productId', component: BomDetailComponent, data: { title: 'BOM.DETAIL_TITLE' } },
  { path: '', component: BomsComponent, data: { title: 'MENU.BOMS' } },
];
