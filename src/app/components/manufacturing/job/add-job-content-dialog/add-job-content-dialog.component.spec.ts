...
import { AddJobContentDialogComponent } from './add-job-content-dialog.component';

describe('AddJobContentDialogComponent', () => {
  let component: AddJobContentDialogComponent;
  let fixture: ComponentFixture<AddJobContentDialogComponent>;
  let dialogRef: jasmine.SpyObj<MatDialogRef<AddJobContentDialogComponent>>;

  beforeEach(async () => {
    dialogRef = jasmine.createSpyObj<MatDialogRef<AddJobContentDialogComponent>>('MatDialogRef', ['close']);

    await TestBed.configureTestingModule({
      declarations: [AddJobContentDialogComponent],
      ...
      .overrideComponent(AddJobContentDialogComponent, {
        set: { template: '' },
      })
      .compileComponents();

    fixture = TestBed.createComponent(AddJobContentDialogComponent);
