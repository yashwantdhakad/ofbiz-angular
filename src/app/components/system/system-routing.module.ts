...
const routes: Routes = [
  ...
  { path: 'audit-log', component: AuditLogComponent, data: { title: 'SYSTEM.AUDIT_LOG_TITLE' } },
  { path: 'email-notifications', component: EmailNotificationAdminComponent, data: { title: 'SYSTEM.EMAIL_NOTIFICATIONS_TITLE' } },
];
