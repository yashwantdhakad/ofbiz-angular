...
@NgModule({
  ...
  imports: [
    ...
    RouterModule.forChild([
      { path: '', component: TransferDetailComponent, data: { title: 'TRANSFER.DETAIL_TITLE' } },
      { path: 'receive', component: TransferReceiveComponent, data: { title: 'TRANSFER.RECEIVE_TITLE' } },
    ]),
    FormsModule,
    ReactiveFormsModule,
